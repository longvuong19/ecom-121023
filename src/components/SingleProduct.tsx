      ...
      <div className="flex flex-col justify-center gap-y-10">
        ...
        <div
          onClick={() =>
            ...
            toast.success(
              `${product?.title.substring(0, 100)} has been added to your cart!`
            )
          }
          className="flex items-center cursor-pointer group"
        >
          <button className="bg-darkText text-slate-100 px-6 py-3 text-sm uppercase flex items-center border-r-slate-500">
            Add to cart
          </button>
